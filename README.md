...
> **I take ambiguous ideas to production and turn them into companies.**
> Backend architecture, AI copilots, data pipelines, and UX that respects the user — I own the whole stack from first commit to shipped product. Two live products, one operator.
...
<table>
  <tr>
    <td width="50%" valign="top">
      <h3>🎛️ <a href="https://artyphonic.com">Artyphonic</a></h3>
      <p><em>Your studio, online.</em></p>
      <p>Client-work OS for music producers &amp; mix/mastering engineers. Versioned tracks, feedback pinned to the exact second, approvals, Stripe payouts, and lossless streaming for clients — no login required.</p>
      <p>
    ...
    <td width="50%" valign="top">
      <h3>🌍 <a href="https://traveleon.ai">Traveleon</a></h3>
      <p><em>Plan a whole trip in plain English.</em></p>
      <p>AI travel planner that turns one sentence into a full itinerary — hotels, activities, and routing. Groups vote and edit in real time, then book everything in one click.</p>
      <p>
...
<!-- ====================== HOW I OPERATE ====================== -->
### ⚡ How I operate
- **Ship, then sharpen.** Get it in front of users, measure, iterate — perfection is a moving target you hit in production.
...
<!-- ====================== CONTRIBUTION SNAKE ====================== -->
<!-- Powered by .github/workflows/snake.yml — regenerates every 12h on the default branch. -->
<p align="center">
  <img src="https://raw.githubusercontent.com/farahtrip/farahtrip/output/github-snake-dark.svg" alt="contribution snake" width="100%" />
</p>

---

### 🤝 Work with me
- **🚀 0→1 product** — bring me an ambiguous idea; get a scoped, shippable product with the pipes to grow.
- **🎯 Fractional CTO** — stand up infra, automate releases, and level up a team on modern data + AI.
- **🔍 Deep dives** — a gnarly Celery workflow, a melting Elasticsearch cluster, or vector-search relevance that won't behave? That's my idea of fun.
...
<!-- ====================== FOOTER ====================== -->
<p align="center">
  <a href="mailto:sorin@scarabytes.com">📫 sorin@scarabytes.com</a> &nbsp;•&nbsp;
  <a href="https://artyphonic.com">🎛️ artyphonic.com</a> &nbsp;•&nbsp;
  <a href="https://traveleon.ai">🌍 traveleon.ai</a> &nbsp;•&nbsp;
